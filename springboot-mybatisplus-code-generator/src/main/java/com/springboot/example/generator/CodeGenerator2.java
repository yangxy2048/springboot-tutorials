...
public class CodeGenerator2 {
    ...
    //项目路径
    private static final String BASE_PROJECT_PATH = "/Users/devinyang/Downloads/code/merchantaccount2";
    //包名
    ...
    private static String url = "jdbc:mysql://localhost:3306/MerchantAccount?serverTimezone=GMT%2B8";
...
//                })
        ...
        gen.setGlobalConfig(new GlobalConfig()
                .setOutputDir( BASE_PROJECT_PATH + "/src/main/java")//输出目录
        ...
        fileOutList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return BASE_PROJECT_PATH + "/src/main/resources/mappers/" + tableInfo.getEntityName() + ".xml";
            }
        });
